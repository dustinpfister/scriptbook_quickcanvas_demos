...
(function () {
	...
	draw = function (ctx) {
		...
		//startBlue = 255 - Math.floor(Math.abs(map.y) / 25) * 12;
		startBlue = 255 - Math.floor(map.y / map.maxY * 255);
		i = 0;
		i2 = 0;

		var blueStep = 255 / map.maxY * map.cellH;
		//var blueStep = 12;
		var out = 'y: ' + map.y + ', startBlue: ' + startBlue;
